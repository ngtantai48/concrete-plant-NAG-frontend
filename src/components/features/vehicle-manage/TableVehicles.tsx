  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_: unknown, record: Vehicle) => (
        <Space size="middle">
          {hasActionAccess(SIDEBAR.VEHICLES, PERMISSIONS.VEHICLES.UPDATE) && (
          ...
          {hasActionAccess(SIDEBAR.VEHICLES, PERMISSIONS.VEHICLES.DELETE) && (
            <Popconfirm
      ...
      <div className="m-10 bg-white rounded-lg shadow-sm border border-slate-200 animate-fade-in overflow-hidden">
        <div className="p-6 md:p-8 border-b-2 border-slate-100 flex flex-col items-start gap-6 bg-slate-50/50">
          ...
          <div className="flex gap-3 mt-2 sm:mt-0 flex-wrap">
            {hasActionAccess(SIDEBAR.VEHICLES, PERMISSIONS.VEHICLES.CREATE) && (
