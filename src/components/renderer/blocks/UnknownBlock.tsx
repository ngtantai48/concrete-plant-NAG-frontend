...
export function UnknownBlock({ data, error }: { data: unknown; error?: ZodError }) {
  ...
  const reason = error?.issues[0]?.message ?? "Render block không khớp schema đã khai báo.";

  return (
    <div
      className="rounded-md border border-[rgba(255,159,10,0.32)] bg-[rgba(255,159,10,0.10)] p-3 text-[12px] text-[#B86E00] dark:border-[rgba(255,196,93,0.34)] dark:bg-[rgba(255,159,10,0.16)] dark:text-[#FFC45D]"
...
export function BlockSkeleton() {
  return (
    <div
      className="relative overflow-hidden rounded-md border border-black/10 bg-white p-4 shadow-[0_10px_28px_-22px_rgba(15,23,42,0.55)] dark:border-white/10 dark:bg-zinc-950"
    ...
    >
      ...
      <div className="relative rounded-md border border-black/[0.06] bg-zinc-50/85 p-3 blur-[0.6px] dark:border-white/[0.08] dark:bg-white/[0.04]">
